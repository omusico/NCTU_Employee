<?php   	
		...
		try{
			...
			//$db = new PDO("sqlsrv:server=140.113.40.22,1633;database=兼任人員資料庫測試機","PTemploy","PT41107employ");
			//$db = new PDO("sqlsrv:server=140.113.41.22,1633;database=兼任人員資料庫","PTemploy","PT41107employ");
			//$db = new PDO("sqlsrv:server=140.113.41.22,1633;database=兼任0401","PTemploy","PT41107employ");
