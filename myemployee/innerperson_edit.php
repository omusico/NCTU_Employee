	...
	$("select[name='select_month']").change(function(){
		...
		if(value==2){
			...
			$("input[name='update']").click(function(){
				...
				$("select[name='student_grade']").prop("disabled", false);
			...
			$("select[name='student_grade']").prop("disabled", true);
			$("input[name='schoolName']").prop("readonly", true);
			$("input[name='comName']").prop("readonly", true);
...
<form action="innerpersonoperation.php" name="apply_form" method="post" enctype="multipart/form-data">
