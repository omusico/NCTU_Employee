...
class=GramE>請核單</span><span lang=EN-US><o:p></o:p></span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size:10.0pt;font-family:標楷體'>表單編號：<%=Listemploy_MRst("SerialNo")%></span></p></p>
...
style='mso-spacerun:yes'>&nbsp;<%=year(Trim(Listemploy_MRst("createtime")))-1911%>&nbsp; </span></span>年<span lang=EN-US><span
style='mso-spacerun:yes'>&nbsp;<%=month(Trim(Listemploy_MRst("createtime")))%>&nbsp; </span></span>月<span lang=EN-US><span
style='mso-spacerun:yes'>&nbsp;<%=day(Trim(Listemploy_MRst("createtime")))%> </span></span>日 <span lang=EN-US><o:p></o:p></span></span></p>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=981
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid;
  ...
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='mso-bidi-font-size:12.0pt;font-family:標楷體'><o:p><%=depname%>&nbsp;</o:p></span></p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:28.65pt'>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='mso-bidi-font-size:12.0pt;font-family:標楷體'><%=leader%>&nbsp;</span></p>
  </td>
  ...
  font-family:標楷體'><o:p><%=BugNo%>&nbsp;&nbsp;<%=bugname%></o:p>
  </span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1;page-break-inside:avoid;height:28.65pt'>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:28.65pt'>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='mso-bidi-font-size:12.0pt;font-family:標楷體'><o:p><%=start%>&nbsp;-&nbsp;<%if delay<>"" then response.Write delay else response.Write deadline end if%></o:p></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:2;page-break-inside:avoid;height:28.65pt'>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:28.65pt'>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='mso-bidi-font-size:12.0pt;font-family:標楷體'><%=Trim(Listemploy_MRst("GiveUnit"))%></span></p>
  </td>
  <td width=236 colspan=3 style='width:177.3pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  font-family:標楷體'>是否為直屬主管之配偶或<span lang=EN-US><o:p></o:p></span></span></p>
  <p class=MsoNormal style='line-height:12.0pt;layout-grid-mode:char;
  mso-layout-grid-align:none'><span style='mso-bidi-font-size:12.0pt;
  font-family:標楷體'>三等親等內之血親、姻親<span lang=EN-US><o:p></o:p></span></span></p>
  </td>
  ...
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>□是<span lang=EN-US><span
  style='mso-spacerun:yes'>&nbsp; </span><span
  style='mso-spacerun:yes'>&nbsp;</span><span
  style='mso-spacerun:yes'>&nbsp;</span></span><span class=GramE>█否</span><span
  lang=EN-US>(</span>迴避進用新進計畫主持人及共同計畫主持人之配偶及三親等內之血親、姻親<span lang=EN-US>)<o:p></o:p></span></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:3;height:25.5pt'>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:25.5pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>僱用期間<span lang=EN-US><o:p></o:p></span></span></p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:25.5pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>支領<br>項目</p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:25.5pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>每月工作<span lang=EN-US><o:p></o:p></span></span></p>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>時數上限<span lang=EN-US>
  <o:p></o:p></span></span></p>
  </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:25.5pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>工作<span lang=EN-US><o:p></o:p></span></span></p>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>時薪<span lang=EN-US><o:p></o:p></span></span></p>
  </td>
  ...
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:25.5pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='mso-bidi-font-size:12.0pt;font-family:標楷體'>獎助單元<span lang=EN-US><o:p></o:p></span></span></p>
  </td>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:25.5pt'>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph;line-height:10.0pt;mso-line-height-rule:exactly'><span style='font-size:11.0pt;font-family:標楷體'>是否具有<br>原住民身份</span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:4;height:15.25pt'>
  ...
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("TitleName") end if%>&nbsp;</o:p></span></p>
  </td>
  ...
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("IdCode")&Listemploy_DRst("Etitlename")&" "&OutSideTitle end if%>&nbsp;</o:p></span></p>
  </td>
  <td width=72 valign=top style='width:54.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.25pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("Cname") end if%>&nbsp;</o:p></span></p>
  </td>
  <td width=80 colspan=2 valign=top style='width:60.0pt;border-top:none;
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.25pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  year(trim(Listemploy_DRst("Empdate")))-1911&"/"&month(trim(Listemploy_DRst("Empdate")))&"/"&day(trim(Listemploy_DRst("Empdate")))&"&nbsp;-&nbsp;"&year(trim(Listemploy_DRst("Enddate")))-1911&"/"&month(trim(Listemploy_DRst("Enddate")))&"/"&day(trim(Listemploy_DRst("Enddate")))end if%></o:p></span></p>
  </td>
  ...
  <p class=MsoNormal><span lang=EN-US style='font-size:9pt; font-family:標楷體'><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("JobItemName") end if%></span></p>
  </td>
  <td width=80 valign=top style='width:70.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.25pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.25pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("Pay") end if%>&nbsp;</o:p></span></p>
  </td>
  <td width=79 valign=top style='width:59.1pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.25pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("AwardUnit") end if%>&nbsp;</o:p></span></p>
  </td>
  <td width=85 valign=top style='width:63.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.25pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:10pt; font-family:標楷體'><o:p><%if int(Listemploy_DRst("count"))>= i then response.Write  Listemploy_DRst("MonthlyExpenses") end if%>&nbsp;</o:p></span></p>
  </td>
  ...
  9.0pt;font-family:標楷體'><%if trim(Listemploy_DRst("IsAboriginal"))="1" and int(Listemploy_DRst("count"))>= i then response.Write "█" else response.Write "□" end if%>是</span><span
  lang=EN-US style='mso-bidi-font-size:12.0pt;font-family:標楷體'>
  </span><span class=GramE><span style='mso-bidi-font-size:9.0pt;font-family:
  標楷體'><%if trim(Listemploy_DRst("IsAboriginal"))="0" and int(Listemploy_DRst("count"))>= i then response.Write "█" else response.Write "□" end if%></span></span><span style='mso-bidi-font-size:9.0pt;font-family:標楷體'>否
  <!-->考量個資問題，不顯示是否身心障礙者<-->
  </span></p>
  </td>
...
<span
  lang=EN-US style='font-size:8pt; font-family:標楷體'><o:p>
  <%if int(Listemploy_DRst("count"))>= i then 
  response.Write  Listemploy_DRst("memo")
	if Trim(Listemploy_DRst("memo"))<>"" THEN Response.Write "<br>" END IF
	  ...
	  if len(trim(Listemploy_DRst("IdCode")))>6 then  
			...
			if not checkDouRst.EOF then  
				if checkLeaveTime("在離職狀態")="在職" then
					response.Write " (具有專任身份，工號："&checkDouRst("EmpNo")&")<br>" 
				end if
			end if						
	  end if
	...
	if int(Listemploy_DRst("count"))>= i then 
		IF OutSideUnit<>"" THEN
			Response.Write "服務機關："&OutSideUnit&""
		END IF
	end if
  %>
 ...
 <tr style='mso-yfti-irow:10;mso-yfti-lastrow:yes;height:17.7pt'>
  ...
  <p class=MsoListParagraph style='margin-left:18.0pt; mso-para-margin-left:0gd; text-indent:-18.0pt; line-height:12pt;layout-grid-mode:char; mso-layout-grid-align:none'><span style='mso-bidi-font-size:12.0pt;font-family:標楷體'>&nbsp;二、依「行政院國家科學委員會補助專題研究計畫助理人員約用注意事項」規定略以，進用助理人員時，應由計畫主持人事先核准後，始得約用之。</span></p>
  <p class=MsoListParagraph style='margin-left:18.0pt;mso-para-margin-left:0gd;text-indent:-18.0pt;line-height:14.0pt;layout-grid-mode:char;mso-layout-grid-align:none'><span style='mso-bidi-font-size:12.0pt;font-family:標楷體'>&nbsp;三、依「行政院及所屬各機關學校臨時人員進用及運用要點」及科技部規定略以，應迴避進用機關首長、計畫主持人、共同主持人及所屬單位主管之配偶及三親等以內血親、姻親為助理人員，如有違反規定，不予核銷相關經費。</span></p>
  
  <p class=MsoListParagraph style='margin-left:18.0pt;mso-para-margin-left:0gd;text-indent:-18.0pt;line-height:14.0pt;layout-grid-mode:char;mso-layout-grid-align:none'><span style='mso-bidi-font-size:12.0pt;font-family:標楷體'>&nbsp;四、本校專任人員擔任兼任人員或臨時工時，應經本職計畫主持人（或單位主管）同意，請該計畫主持人（或單位主管）於該員備註欄簽章，以表同意。</span></p>
  
  <p class=MsoListParagraph style='margin-left:17.85pt;text-indent:-17.85pt;line-height:14.0pt;layout-grid-mode:char;mso-layout-grid-align:none'><span style='mso-bidi-font-size:12.0pt;font-family:標楷體'>&nbsp;五、博士候選人請檢附資格證明文件。</span></p>
