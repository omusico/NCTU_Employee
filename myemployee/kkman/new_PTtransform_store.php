...
<body bgcolor='#c1cfb4'>
	...
	<?
						...
						echo "</tr>";
						echo "<tr>";
						echo "<tr id='tr_".$row['Eid']."_0'><td colspan='10'>異動後".
							 "&nbsp;&nbsp;<img src='pics/plus.gif' style='cursor:pointer;' onClick=\"javascript:add_Row('".trim($row['Eid'])."','".$bug_type."','".$row['PTtitle']."');\">".
