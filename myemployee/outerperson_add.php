...
// 	echo $filetypes[1]."<br/>";
	...
	$sqlInsert="insert into OuterStatus (SerialNo,IdNo,Name,isNCTU,Birthday,RecordStatus,isStudent,isJob,schoolName,comName,Education,studentGrade,UpdateDate,UpdateEmpNo,CreateDate,CreateEmp)";
	$sqlInsert.=" values('0000','".$id."','".$name."','0','".$birth."','0','".$isStudent."','".$isJob."','".$schoolName."','".$comName."','".$job_grade."','".$student_grade."',getdate(),'".$empid."',getdate(),'".$empid."')";
	echo $sqlInsert;
	$db->exec($sqlInsert);
